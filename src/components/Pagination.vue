<template>
  <div
    class="flex flex-col sm:flex-row items-center relative bg-gray-100 p-4 rounded"
    :class="[currentPage > 1 ? 'justify-between' : 'justify-end']"
    style="--fa-primary-color: #0290c9; --fa-secondary-color: #0290c9"
  >
    <span
      class="border-b border-gray-200 pb-2 sm:absolute sm:border-none sm:pb-0 left-0 flex justify-center w-full pointer-events-none text-gray-700"
      style="order: -1"
