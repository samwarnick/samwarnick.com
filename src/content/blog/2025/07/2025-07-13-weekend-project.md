...
summary: >-
  ...
  overly complicated MicroPub setup.
tags:
  - Web Development
  - Blog
---
...
The CLI has three actions—`new`, `prepare`, and `publish`. I'll walk through a bit of what each does.
...
Basically, need to copy my draft media to `/media` so the URLs will work. But I only do that on non-production builds.
...
Here's a picture to test out that functionality.

![Soft evening light illuminates billowing pink-tinged clouds above a serene marsh, framed by silhouetted trees in the foreground and a distant horizon under a tranquil blue sky.](https://samwarnick.com/media/IMG_1661.jpeg)
