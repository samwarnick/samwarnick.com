...
date: '2026-05-12T19:57'
published: true
summary: >-
  I've been experimenting with local AI models and checking on my
  projects—everything is surprisingly stable and working, which is both good and
  unsettling.
tags:
  - Projects
  - Self-hosting
...
As an experiment though, I did have Gemma 4 migrate an app of mine from [Perfect Stack](https://samwarnick.com/blog/the-perfect-stack/) to SvelteKit. It did not do great, but not terribly either. Initial attempt took 35 minutes and it didn't run. Then there was a lot of back and forth. Finally got it running after about an hour total. I'm partially to blame because I said to keep using bun when it should've just used node. Possible, but not something I'm going to do regularly.
