...
Mine will copy images to my drafts folder, rename them something simple like `media-1.jpeg`, `media-2.jpeg`, etc. and then ask if I want to append it to a draft. This post is really to make sure all that is working.

So here's a picture:

![Gnarled tree branches silhouetted against a golden sunset, overlooking distant mountain ranges with soft autumn foliage in the foreground.](/media/2026/01/2026-01-31-just-testing-things-out1.JPG)
