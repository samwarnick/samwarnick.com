...
date: '2026-08-03T08:54'
published: true
summary: Getting ScreenCred polished up.
tags:
  - ScreenCred
  - Devlog
---
...
![ScreenCred comparison screen for Andor (2006) and Rogue One: A Star Wars Story (2016), showing shared cast and crew members including Forest Whitaker as Saw Gerrera, Alan Tudyk as K-2SO, and George Lucas, each with an info icon.](/media/2026/08/2026-08-03-devlog-jul-20-aug-21.png)

- Added more gradients. For fun. I like it.
- Switched to using a proxy to access the TMDB API instead of going direct.
