...
`deploybot-3000` reads that and does it magic[^3].

It is in no way ready for prime time, but I'm excited by it. There's about a 1000 ways it needs to be improved, and I'm sure it will break in new and exciting ways on every app change. But that didn't stop me from switching all my stuff over from Coolify and shutting down my Coolify VMs. At the moment, I have 2 instances running—public and internal. Between them are 3 apps and 2 Eleventy blogs. I think they work.

## But I might not use it

This project has consumed me. I would be kept up at night thinking about how to solve different problems, make different features more elegant, or how to implement something. It drive me crazy. Like my brain hurts.

I can do this. I've proved it to myself. It's kinda neat even. But this effort of trying to host everything myself is really starting to feel like it is going to cost me my sanity. The rational solution would be to use the myriad of solutions out there—Netlify, Railway, Fly, etc. Pick the right tool for the right job. Static sites on Netlify. Apps on Railway. IDK.
